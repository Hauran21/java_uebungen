  ...
  ledctrl_interfaces__srv__BacklightValue_Request * output)
{
  ...
  // brightness_percent
  output->brightness_percent = input->brightness_percent;
  return true;
}
...
ledctrl_interfaces__srv__BacklightValue_Request__create(void)
{
  ...
  ledctrl_interfaces__srv__BacklightValue_Request * msg = (ledctrl_interfaces__srv__BacklightValue_Request *)allocator.allocate(sizeof(ledctrl_interfaces__srv__BacklightValue_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ledctrl_interfaces__srv__BacklightValue_Request));
  bool success = ledctrl_interfaces__srv__BacklightValue_Request__init(msg);
  if (!success) {
...
ledctrl_interfaces__srv__BacklightValue_Request__destroy(ledctrl_interfaces__srv__BacklightValue_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ledctrl_interfaces__srv__BacklightValue_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
ledctrl_interfaces__srv__BacklightValue_Request__Sequence__init(ledctrl_interfaces__srv__BacklightValue_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ledctrl_interfaces__srv__BacklightValue_Request * data = NULL;

  if (size) {
    data = (ledctrl_interfaces__srv__BacklightValue_Request *)allocator.zero_allocate(size, sizeof(ledctrl_interfaces__srv__BacklightValue_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ledctrl_interfaces__srv__BacklightValue_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ledctrl_interfaces__srv__BacklightValue_Request__fini(&data[i - 1]);
      }
...
ledctrl_interfaces__srv__BacklightValue_Request__Sequence__fini(ledctrl_interfaces__srv__BacklightValue_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ledctrl_interfaces__srv__BacklightValue_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ledctrl_interfaces__srv__BacklightValue_Request__Sequence * array = (ledctrl_interfaces__srv__BacklightValue_Request__Sequence *)allocator.allocate(sizeof(ledctrl_interfaces__srv__BacklightValue_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ledctrl_interfaces__srv__BacklightValue_Request__Sequence__init(array, size);
  if (!success) {
...
ledctrl_interfaces__srv__BacklightValue_Request__Sequence__destroy(ledctrl_interfaces__srv__BacklightValue_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ledctrl_interfaces__srv__BacklightValue_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ledctrl_interfaces__srv__BacklightValue_Request__Sequence__are_equal(const ledctrl_interfaces__srv__BacklightValue_Request__Sequence * lhs, const ledctrl_interfaces__srv__BacklightValue_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ledctrl_interfaces__srv__BacklightValue_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ledctrl_interfaces__srv__BacklightValue_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ledctrl_interfaces__srv__BacklightValue_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ledctrl_interfaces__srv__BacklightValue_Request * data =
      (ledctrl_interfaces__srv__BacklightValue_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ledctrl_interfaces__srv__BacklightValue_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ledctrl_interfaces__srv__BacklightValue_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ledctrl_interfaces__srv__BacklightValue_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ledctrl_interfaces__srv__BacklightValue_Response * msg = (ledctrl_interfaces__srv__BacklightValue_Response *)allocator.allocate(sizeof(ledctrl_interfaces__srv__BacklightValue_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ledctrl_interfaces__srv__BacklightValue_Response));
  bool success = ledctrl_interfaces__srv__BacklightValue_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ledctrl_interfaces__srv__BacklightValue_Response__destroy(ledctrl_interfaces__srv__BacklightValue_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ledctrl_interfaces__srv__BacklightValue_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
ledctrl_interfaces__srv__BacklightValue_Response__Sequence__init(ledctrl_interfaces__srv__BacklightValue_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ledctrl_interfaces__srv__BacklightValue_Response * data = NULL;

  if (size) {
    data = (ledctrl_interfaces__srv__BacklightValue_Response *)allocator.zero_allocate(size, sizeof(ledctrl_interfaces__srv__BacklightValue_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ledctrl_interfaces__srv__BacklightValue_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ledctrl_interfaces__srv__BacklightValue_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ledctrl_interfaces__srv__BacklightValue_Response__Sequence__fini(ledctrl_interfaces__srv__BacklightValue_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ledctrl_interfaces__srv__BacklightValue_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ledctrl_interfaces__srv__BacklightValue_Response__Sequence * array = (ledctrl_interfaces__srv__BacklightValue_Response__Sequence *)allocator.allocate(sizeof(ledctrl_interfaces__srv__BacklightValue_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ledctrl_interfaces__srv__BacklightValue_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ledctrl_interfaces__srv__BacklightValue_Response__Sequence__destroy(ledctrl_interfaces__srv__BacklightValue_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ledctrl_interfaces__srv__BacklightValue_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ledctrl_interfaces__srv__BacklightValue_Response__Sequence__are_equal(const ledctrl_interfaces__srv__BacklightValue_Response__Sequence * lhs, const ledctrl_interfaces__srv__BacklightValue_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ledctrl_interfaces__srv__BacklightValue_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ledctrl_interfaces__srv__BacklightValue_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ledctrl_interfaces__srv__BacklightValue_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ledctrl_interfaces__srv__BacklightValue_Response * data =
      (ledctrl_interfaces__srv__BacklightValue_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ledctrl_interfaces__srv__BacklightValue_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ledctrl_interfaces__srv__BacklightValue_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ledctrl_interfaces__srv__BacklightValue_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ledctrl_interfaces__srv__BacklightValue_Event__init(ledctrl_interfaces__srv__BacklightValue_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    ledctrl_interfaces__srv__BacklightValue_Event__fini(msg);
    return false;
  }
  // request
  if (!ledctrl_interfaces__srv__BacklightValue_Request__Sequence__init(&msg->request, 0)) {
    ledctrl_interfaces__srv__BacklightValue_Event__fini(msg);
    return false;
  }
  // response
  if (!ledctrl_interfaces__srv__BacklightValue_Response__Sequence__init(&msg->response, 0)) {
    ledctrl_interfaces__srv__BacklightValue_Event__fini(msg);
    return false;
  }
  return true;
...
ledctrl_interfaces__srv__BacklightValue_Event__fini(ledctrl_interfaces__srv__BacklightValue_Event * msg)
{
  ...
  // request
  ledctrl_interfaces__srv__BacklightValue_Request__Sequence__fini(&msg->request);
  // response
  ledctrl_interfaces__srv__BacklightValue_Response__Sequence__fini(&msg->response);
}
...
ledctrl_interfaces__srv__BacklightValue_Event__are_equal(const ledctrl_interfaces__srv__BacklightValue_Event * lhs, const ledctrl_interfaces__srv__BacklightValue_Event * rhs)
{
  ...
  // request
  if (!ledctrl_interfaces__srv__BacklightValue_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!ledctrl_interfaces__srv__BacklightValue_Response__Sequence__are_equal(
  ...
  ledctrl_interfaces__srv__BacklightValue_Event * output)
{
  ...
  // request
  if (!ledctrl_interfaces__srv__BacklightValue_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!ledctrl_interfaces__srv__BacklightValue_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ledctrl_interfaces__srv__BacklightValue_Event * msg = (ledctrl_interfaces__srv__BacklightValue_Event *)allocator.allocate(sizeof(ledctrl_interfaces__srv__BacklightValue_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ledctrl_interfaces__srv__BacklightValue_Event));
  bool success = ledctrl_interfaces__srv__BacklightValue_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ledctrl_interfaces__srv__BacklightValue_Event__Sequence__init(ledctrl_interfaces__srv__BacklightValue_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ledctrl_interfaces__srv__BacklightValue_Event * data = NULL;

  if (size) {
    data = (ledctrl_interfaces__srv__BacklightValue_Event *)allocator.zero_allocate(size, sizeof(ledctrl_interfaces__srv__BacklightValue_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ledctrl_interfaces__srv__BacklightValue_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ledctrl_interfaces__srv__BacklightValue_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ledctrl_interfaces__srv__BacklightValue_Event__Sequence__fini(ledctrl_interfaces__srv__BacklightValue_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ledctrl_interfaces__srv__BacklightValue_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ledctrl_interfaces__srv__BacklightValue_Event__Sequence * array = (ledctrl_interfaces__srv__BacklightValue_Event__Sequence *)allocator.allocate(sizeof(ledctrl_interfaces__srv__BacklightValue_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ledctrl_interfaces__srv__BacklightValue_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ledctrl_interfaces__srv__BacklightValue_Event__Sequence__destroy(ledctrl_interfaces__srv__BacklightValue_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ledctrl_interfaces__srv__BacklightValue_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ledctrl_interfaces__srv__BacklightValue_Event__Sequence__are_equal(const ledctrl_interfaces__srv__BacklightValue_Event__Sequence * lhs, const ledctrl_interfaces__srv__BacklightValue_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ledctrl_interfaces__srv__BacklightValue_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ledctrl_interfaces__srv__BacklightValue_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ledctrl_interfaces__srv__BacklightValue_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ledctrl_interfaces__srv__BacklightValue_Event * data =
      (ledctrl_interfaces__srv__BacklightValue_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ledctrl_interfaces__srv__BacklightValue_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ledctrl_interfaces__srv__BacklightValue_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ledctrl_interfaces__srv__BacklightValue_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
