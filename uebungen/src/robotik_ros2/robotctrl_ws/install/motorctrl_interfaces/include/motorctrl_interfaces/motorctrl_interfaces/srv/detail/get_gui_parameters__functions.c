...
motorctrl_interfaces__srv__GetGUIParameters_Request__create(void)
{
  ...
  motorctrl_interfaces__srv__GetGUIParameters_Request * msg = (motorctrl_interfaces__srv__GetGUIParameters_Request *)allocator.allocate(sizeof(motorctrl_interfaces__srv__GetGUIParameters_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(motorctrl_interfaces__srv__GetGUIParameters_Request));
  bool success = motorctrl_interfaces__srv__GetGUIParameters_Request__init(msg);
  if (!success) {
...
motorctrl_interfaces__srv__GetGUIParameters_Request__destroy(motorctrl_interfaces__srv__GetGUIParameters_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    motorctrl_interfaces__srv__GetGUIParameters_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
motorctrl_interfaces__srv__GetGUIParameters_Request__Sequence__init(motorctrl_interfaces__srv__GetGUIParameters_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  motorctrl_interfaces__srv__GetGUIParameters_Request * data = NULL;

  if (size) {
    data = (motorctrl_interfaces__srv__GetGUIParameters_Request *)allocator.zero_allocate(size, sizeof(motorctrl_interfaces__srv__GetGUIParameters_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = motorctrl_interfaces__srv__GetGUIParameters_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        motorctrl_interfaces__srv__GetGUIParameters_Request__fini(&data[i - 1]);
      }
...
motorctrl_interfaces__srv__GetGUIParameters_Request__Sequence__fini(motorctrl_interfaces__srv__GetGUIParameters_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      motorctrl_interfaces__srv__GetGUIParameters_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  motorctrl_interfaces__srv__GetGUIParameters_Request__Sequence * array = (motorctrl_interfaces__srv__GetGUIParameters_Request__Sequence *)allocator.allocate(sizeof(motorctrl_interfaces__srv__GetGUIParameters_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = motorctrl_interfaces__srv__GetGUIParameters_Request__Sequence__init(array, size);
  if (!success) {
...
motorctrl_interfaces__srv__GetGUIParameters_Request__Sequence__destroy(motorctrl_interfaces__srv__GetGUIParameters_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    motorctrl_interfaces__srv__GetGUIParameters_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
motorctrl_interfaces__srv__GetGUIParameters_Request__Sequence__are_equal(const motorctrl_interfaces__srv__GetGUIParameters_Request__Sequence * lhs, const motorctrl_interfaces__srv__GetGUIParameters_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!motorctrl_interfaces__srv__GetGUIParameters_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  motorctrl_interfaces__srv__GetGUIParameters_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(motorctrl_interfaces__srv__GetGUIParameters_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    motorctrl_interfaces__srv__GetGUIParameters_Request * data =
      (motorctrl_interfaces__srv__GetGUIParameters_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!motorctrl_interfaces__srv__GetGUIParameters_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          motorctrl_interfaces__srv__GetGUIParameters_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!motorctrl_interfaces__srv__GetGUIParameters_Request__copy(
...
motorctrl_interfaces__srv__GetGUIParameters_Response__init(motorctrl_interfaces__srv__GetGUIParameters_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->uart_name)) {
    motorctrl_interfaces__srv__GetGUIParameters_Response__fini(msg);
    return false;
  }
  // uart_baudrate
  // motor_ids
...
motorctrl_interfaces__srv__GetGUIParameters_Response__are_equal(const motorctrl_interfaces__srv__GetGUIParameters_Response * lhs, const motorctrl_interfaces__srv__GetGUIParameters_Response * rhs)
{
  ...
  // wheel_separation
  if (lhs->wheel_separation != rhs->wheel_separation) {
    return false;
  }
  return true;
}
  ...
  motorctrl_interfaces__srv__GetGUIParameters_Response * output)
{
  ...
  // wheel_separation
  output->wheel_separation = input->wheel_separation;
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  motorctrl_interfaces__srv__GetGUIParameters_Response * msg = (motorctrl_interfaces__srv__GetGUIParameters_Response *)allocator.allocate(sizeof(motorctrl_interfaces__srv__GetGUIParameters_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(motorctrl_interfaces__srv__GetGUIParameters_Response));
  bool success = motorctrl_interfaces__srv__GetGUIParameters_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
motorctrl_interfaces__srv__GetGUIParameters_Response__Sequence__init(motorctrl_interfaces__srv__GetGUIParameters_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  motorctrl_interfaces__srv__GetGUIParameters_Response * data = NULL;

  if (size) {
    data = (motorctrl_interfaces__srv__GetGUIParameters_Response *)allocator.zero_allocate(size, sizeof(motorctrl_interfaces__srv__GetGUIParameters_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = motorctrl_interfaces__srv__GetGUIParameters_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        motorctrl_interfaces__srv__GetGUIParameters_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
motorctrl_interfaces__srv__GetGUIParameters_Response__Sequence__fini(motorctrl_interfaces__srv__GetGUIParameters_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      motorctrl_interfaces__srv__GetGUIParameters_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  motorctrl_interfaces__srv__GetGUIParameters_Response__Sequence * array = (motorctrl_interfaces__srv__GetGUIParameters_Response__Sequence *)allocator.allocate(sizeof(motorctrl_interfaces__srv__GetGUIParameters_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = motorctrl_interfaces__srv__GetGUIParameters_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
motorctrl_interfaces__srv__GetGUIParameters_Response__Sequence__destroy(motorctrl_interfaces__srv__GetGUIParameters_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    motorctrl_interfaces__srv__GetGUIParameters_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
motorctrl_interfaces__srv__GetGUIParameters_Response__Sequence__are_equal(const motorctrl_interfaces__srv__GetGUIParameters_Response__Sequence * lhs, const motorctrl_interfaces__srv__GetGUIParameters_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!motorctrl_interfaces__srv__GetGUIParameters_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  motorctrl_interfaces__srv__GetGUIParameters_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(motorctrl_interfaces__srv__GetGUIParameters_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    motorctrl_interfaces__srv__GetGUIParameters_Response * data =
      (motorctrl_interfaces__srv__GetGUIParameters_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!motorctrl_interfaces__srv__GetGUIParameters_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          motorctrl_interfaces__srv__GetGUIParameters_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!motorctrl_interfaces__srv__GetGUIParameters_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
motorctrl_interfaces__srv__GetGUIParameters_Event__init(motorctrl_interfaces__srv__GetGUIParameters_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    motorctrl_interfaces__srv__GetGUIParameters_Event__fini(msg);
    return false;
  }
  // request
  if (!motorctrl_interfaces__srv__GetGUIParameters_Request__Sequence__init(&msg->request, 0)) {
    motorctrl_interfaces__srv__GetGUIParameters_Event__fini(msg);
    return false;
  }
  // response
  if (!motorctrl_interfaces__srv__GetGUIParameters_Response__Sequence__init(&msg->response, 0)) {
    motorctrl_interfaces__srv__GetGUIParameters_Event__fini(msg);
    return false;
  }
  return true;
...
motorctrl_interfaces__srv__GetGUIParameters_Event__fini(motorctrl_interfaces__srv__GetGUIParameters_Event * msg)
{
  ...
  // request
  motorctrl_interfaces__srv__GetGUIParameters_Request__Sequence__fini(&msg->request);
  // response
  motorctrl_interfaces__srv__GetGUIParameters_Response__Sequence__fini(&msg->response);
}
...
motorctrl_interfaces__srv__GetGUIParameters_Event__are_equal(const motorctrl_interfaces__srv__GetGUIParameters_Event * lhs, const motorctrl_interfaces__srv__GetGUIParameters_Event * rhs)
{
  ...
  // request
  if (!motorctrl_interfaces__srv__GetGUIParameters_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!motorctrl_interfaces__srv__GetGUIParameters_Response__Sequence__are_equal(
  ...
  motorctrl_interfaces__srv__GetGUIParameters_Event * output)
{
  ...
  // request
  if (!motorctrl_interfaces__srv__GetGUIParameters_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!motorctrl_interfaces__srv__GetGUIParameters_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  motorctrl_interfaces__srv__GetGUIParameters_Event * msg = (motorctrl_interfaces__srv__GetGUIParameters_Event *)allocator.allocate(sizeof(motorctrl_interfaces__srv__GetGUIParameters_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(motorctrl_interfaces__srv__GetGUIParameters_Event));
  bool success = motorctrl_interfaces__srv__GetGUIParameters_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
motorctrl_interfaces__srv__GetGUIParameters_Event__Sequence__init(motorctrl_interfaces__srv__GetGUIParameters_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  motorctrl_interfaces__srv__GetGUIParameters_Event * data = NULL;

  if (size) {
    data = (motorctrl_interfaces__srv__GetGUIParameters_Event *)allocator.zero_allocate(size, sizeof(motorctrl_interfaces__srv__GetGUIParameters_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = motorctrl_interfaces__srv__GetGUIParameters_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        motorctrl_interfaces__srv__GetGUIParameters_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
motorctrl_interfaces__srv__GetGUIParameters_Event__Sequence__fini(motorctrl_interfaces__srv__GetGUIParameters_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      motorctrl_interfaces__srv__GetGUIParameters_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  motorctrl_interfaces__srv__GetGUIParameters_Event__Sequence * array = (motorctrl_interfaces__srv__GetGUIParameters_Event__Sequence *)allocator.allocate(sizeof(motorctrl_interfaces__srv__GetGUIParameters_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = motorctrl_interfaces__srv__GetGUIParameters_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
motorctrl_interfaces__srv__GetGUIParameters_Event__Sequence__destroy(motorctrl_interfaces__srv__GetGUIParameters_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    motorctrl_interfaces__srv__GetGUIParameters_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
motorctrl_interfaces__srv__GetGUIParameters_Event__Sequence__are_equal(const motorctrl_interfaces__srv__GetGUIParameters_Event__Sequence * lhs, const motorctrl_interfaces__srv__GetGUIParameters_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!motorctrl_interfaces__srv__GetGUIParameters_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  motorctrl_interfaces__srv__GetGUIParameters_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(motorctrl_interfaces__srv__GetGUIParameters_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    motorctrl_interfaces__srv__GetGUIParameters_Event * data =
      (motorctrl_interfaces__srv__GetGUIParameters_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!motorctrl_interfaces__srv__GetGUIParameters_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          motorctrl_interfaces__srv__GetGUIParameters_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!motorctrl_interfaces__srv__GetGUIParameters_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
