...
def generate_launch_description():
    ...
    use_fake_nodes = LaunchConfiguration("use_fake_nodes")
    group_fake = GroupAction(
        condition=IfCondition(use_fake_nodes),
        actions=[
            Node(
                package="motorctrl",
                executable="dummy",
    ...
    group_real= GroupAction(
        condition=UnlessCondition(use_fake_nodes),
        actions=[
            Node(
                package="motorctrl",
